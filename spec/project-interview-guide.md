...
Its job is to turn an idea into clear project files.
...
- gather enough information to create or update:
  ...
  - `spec/logging.md` only if needed by the project
...
2. draft content for the relevant project files
...
- `spec/spec.md`
- `spec/ui-guidelines.md`
- `spec/logging.md` only if the project needs explicit runtime diagnostics
...
- Do we have enough detail to draft the project files?
...
- Project summary
- Draft `spec/spec.md`
- Draft `spec/ui-guidelines.md`
- Draft `spec/product-language.md`
- Draft `spec/logging.md` only if needed
- Open questions
- Assumptions
...
At the end I will draft the project files and list only the remaining important open questions."
